...
public class CostoMinimo {
 ...
 /**
  * 
  * @param tableSolucion tabla donde se va montando la solución
  * @return retorna true si ha podido dar solución al modelo de transporte
  */
    ...
    /**
     * buca la celda que contenga el menor costo
     */
