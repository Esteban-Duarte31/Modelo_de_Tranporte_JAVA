...
public class EsquinaNO {
   ...
   private int columna = datos[0].length;
    ...
    /**
     * 
     * @param tableSolucion tabla donde se va trabajando la solucíon del modelo
     * @param modeloSolucion modelo solución
     * @return retorna tru en caso de poder resolver el modelo de lo contrario retorna false
     */
     ...
     * 
     * @param tableSolucion tabla donde se va trabajando la solucíon del modelo
     * @param extraf contiene 1 si hay un origen ficticio y cero en caso contrario
     * @param extraC contiene 1 si hay un destino ficticio y cero en caso contrario
     */
