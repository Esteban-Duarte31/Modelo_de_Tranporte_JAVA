...
public class CrearTablaTransporte {
   ...
   /**
    * 
    * @param destino cantidad de destinos 
    * @param origen cantidad de origenes
    * @param jtRestricciones tabla del modelo a resolver(sacar restricciones)
    * @param des 
    ...
    */
    ...
    /**
     * 
     * @param jtRestriciones restricciones de tabla
     * @param jtSolucion tabla con la solución
     * @param extraRow trae 1 si hay origen ficticio de lo contrario será 0
     * @param extaColumn trae 1 si hay destinos ficticio de lo contrario será 0
     */
